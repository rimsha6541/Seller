  ...
  return (
    <div className="py-4 text-gray-500 dark:text-gray-400">
      <a className=" text-gray-900 dark:text-gray-200" href="/dashboard">
        {mode === 'dark' ? (
          <img src={logoLight} width="135" className="pl-6" />
        ) : (
          <img src={logoDark}  width="1360" className="pl-6" />
        )}
        <div style={{ display: 'flex', alignItems: 'center' }}>
  <img src="logo-dark.png" style={{  height:'50px',width: '160px', marginRight: '10px',paddingLeft:'20px'}} />
